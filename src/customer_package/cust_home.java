...
public class cust_home extends javax.swing.JFrame {
    ...
    public void set_details(String st)
    {
        ...
        try {
            ...
            if(s.next())
            {
               ...
               if(Float.parseFloat(s.getString(6))<3)
                   RRating.setForeground(Color.red);
               else if(Float.parseFloat(s.getString(6))<4)
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setSize(new java.awt.Dimension(750, 680));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(custPane, javax.swing.GroupLayout.DEFAULT_SIZE, 638, Short.MAX_VALUE)
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
